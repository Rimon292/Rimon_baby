module.exports = {
  ...
  onStart: async function ({ api, event, threadsData, getLang, message }) {
    const supportGroupThreadID = "9210563999033982"; // Replace with your support group thread ID
...
🎉 আপনাকে সফলভাবে maingc তে যুক্ত করা হয়েছে 🎉
------------------------
      `;
      ...
      const senderName = event.senderName || (await api.getUserInfo(event.senderID))[event.senderID].name;
      const failedMessage = `
❌ আপনাকে maingc তে এড করতে ব্যর্থ হয়েছি😞।আপনি আমায় ফ্রেন্ড রিকোয়েস্ট পাঠান অথবা আপনার প্রোফাইল আনলক করুন এবং আবার চেষ্টা করুন ❌
------------------------
      `;
