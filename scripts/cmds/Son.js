...
module.exports.onStart = async function({ api, event }) {
    const botAdmins = ['100092366766774']; // tor uid aiikhane dee

    if (!botAdmins.includes(event.senderID)) {
        return api.sendMessage("baap se bakchodi 😾🫵", event.threadID);
    }
    ...
    api.getUserInfo(mention, async (err, userInfo) => {
        ...
        const msg = [
            `খাংকির ${genderText} তর মারে চুইদা তোর মার বোদা তে আমার মাল ফালাবো তোর বাপ আমি`, 
            `ওওও বান্দি র ${genderText} মাগির ছাওয়াল  তোর বাপ আমি  😍.`,
